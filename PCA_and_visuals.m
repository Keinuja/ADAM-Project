...
plot(PC(i2_end+1:i14_end,1),PC(i2_end+1:i14_end,2),'c*')
...
legend('WT2','WT14 good','WT39 good','WT14 faulty','WT39 faulty')
...
subplot(1,3,1)
biplot(W(:,1:2),'Scores',T(1:i2_end,1:2))
title('WT2')

subplot(1,3,2)
biplot(W(:,1:2),'Scores',[T(i2_end+1:i14_end,1:2);WT14_faulty_PC(:,1:2)])
title('WT14')

subplot(1,3,3)
biplot(W(:,1:2),'Scores',[T(i14_end+1:i39_end,1:2);WT39_faulty_PC(:,1:2)])
title('WT39')
